...
Settings.Color_Base		= Color( 238, 238, 238, 235 )
Settings.Color_Ply 		= Color( 149, 165, 166, 255 )
Settings.Color_Sec1		=Color( 205, 205, 205, 245 )

Settings.Color_Divi		= Color( 51, 51, 51, 255 )

Settings.Color_Text1 	= Color( 51, 51, 51, 255 )
Settings.Color_Text2 	= Color( 245, 245, 245, 255 )
...
local function HUD_Base()
	...
	--Base
	draw.RoundedBox( 8, Settings.PosX, Settings.PosY, Settings.Width, Settings.Height, Settings.Color_Base )
	
	--Squares
	draw.RoundedBoxEx(4, Settings.PosX + Settings.Width - 50, Settings.PosY, 50, Settings.Height, Color(192,192,192,250), false, true, false, false)
	
	--Edges
	draw.RoundedBox(4, Settings.PosX + Settings.Width - 50, Settings.PosY, 6, Settings.Height, Color(151,151,151,240), false, true, false, false)
	draw.RoundedBox(4, Settings.PosX + Settings.Width - 359, Settings.PosY, 3, Settings.Height - 50, Color(161,151,161,240), false, false, false, false)
	draw.RoundedBox(4, Settings.PosX + Settings.Width - 700, Settings.PosY, 6, Settings.Height - 50, Color(161,161,161,240), false, false, false, false)
...
local function HUD_Player()
	...
	--> Background
	draw.RoundedBox( 8, Settings.PosX+10, Settings.PosY+10, 80, 80, Settings.Color_Ply )
...
local function PlayerModel()
	...
	timer.Create( "sg_v1_update", 1, 0, function()
...
local function HUD_Info()
	...
	--> Divider
	draw.RoundedBox( 0, Divider1_X - 5, Divider_Y, Divider_W + 2, 2, Settings.Color_Divi )
	draw.RoundedBox( 0, Divider2_X - 40, Divider_Y, Divider_W, 2, Settings.Color_Divi )
	...
	local PlayerName 	= TextOverflow( PlayerNameVar, 	"SG_HUD_24", InfoWidth/2 )
	local PlayerJob		= TextOverflow( PlayerJobVar, 	"SG_HUD_24", InfoWidth/2 )
	local PlayerWallet 	= "$"..FormatNumber( PlayerWalletVar )
	local PlayerSalary 	= "$"..FormatNumber( PlayerSalaryVar )

	--> Draw Text
	draw.DrawText( PlayerName, 	"SG_HUD_22", Divider1_X+(InfoWidth/2)/2, Divider_Y-24, Settings.Color_Text1, 1 )
	draw.DrawText( PlayerJob, 	"SG_HUD_24", Divider1_X+(InfoWidth/2)/2, Divider_Y+4, Settings.Color_Text1, 1 )

	draw.DrawText( PlayerWallet, 	"SG_HUD_22", Divider2_X+(InfoWidth/2)/2, Divider_Y-24, Settings.Color_Text1, 1 )
	draw.DrawText( PlayerSalary, 	"SG_HUD_24", Divider2_X+(InfoWidth/2)/2, Divider_Y+4, Settings.Color_Text1, 1 )
	draw.DrawText("Salary: ", "SG_HUD_22", Divider2_X + 21, Divider_Y+5, Settings.Color_Text1, 1, Color(0, 0, 0, 255))
	draw.DrawText("Money: ", "SG_HUD_22", Divider2_X + 21, Divider_Y-24, Settings.Color_Text1, 1, Color(0, 0, 0, 255))
	draw.DrawText("Job: ", "SG_HUD_22", Divider2_X - 130, Divider_Y+5, Settings.Color_Text1, 1, Color(0, 0, 0, 255))
...
local function HUD_Health()
	...
	--> Background
	draw.RoundedBox( 8, Settings.PosX+10, HealthDrawY, Settings.Width - 60, 22, Settings.Color_Ply )
	...
	if DrawValue != 0 then
		draw.RoundedBox( 8, Settings.PosX+10, HealthDrawY, DrawWidth * DrawValue / 110, 22, Settings.Color_Health )
	end
	...
	--> Text
	draw.DrawText( DrawText, "SG_HUD_18", DrawTextX, DrawTextY, Settings.Color_Text2, 1 )
...
local function HUD_Armor()
	...
	--> Background
	draw.RoundedBox( 8, Settings.PosX+10, ArmorDrawY, Settings.Width - 60, 22, Settings.Color_Ply )
	...
	if DrawValue != 0 then
		draw.RoundedBox( 8, Settings.PosX+10, ArmorDrawY, DrawWidth * DrawValue / 110, 22, Settings.Color_Armor )
	end
...
local function HUD_Stamina()
	...
	--> Background
	draw.RoundedBox( 0, Settings.PosX+10, StaminaDrawY, Settings.Width - 20, 22, Settings.Color_Ply )
...
local function HUD_Hunger()
	...
	--> Background
	draw.RoundedBox( 0, Settings.PosX+10, HungerDrawY, Settings.Width - 20, 22, Settings.Color_Ply )
...
local function LockDown()
	...
	if GetGlobalBool("DarkRP_LockDown") then
		...
		local chatBoxSize = math.floor(4 / 4)
...
MsgC(Color(0,255,0), "---->\n")
print("\n")
MsgC(Color(255, 0, 0), " > ") MsgC(Color(255,255,255), "Saturn Graphics Hud ...\n")
MsgC(Color(255, 0, 0), " > ") MsgC(Color(255,255,255), "Version: 1.0\n")
print("\n")
MsgC(Color(255, 0, 0), " > ") MsgC(Color(255,255,255), "Updates can be found on my Github or pm me on my forum!\n")
MsgC(Color(255, 0, 0), " > ") MsgC(Color(255,255,255), "https://Skuttlekrew.comyr.com\n")
print("\n")
MsgC(Color(0,255,0), "---->\n")
print("\n")
...
hook.Add( "HUDPaint", "SG_V1_Paint", SG_V1_Paint )
